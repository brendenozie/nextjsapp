...
const Footer = (props: Props) => {
  return (
    <footer className="bg-white">
      <div
        className="mx-auto max-w-full space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8"
      >
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div>
            ...
            <ul className="mt-8 flex gap-6">
              <li>
                <Link
                  href="facebook.com/HobbyHorseTours"
                  rel="noreferrer"
                  target="_blank"
              ...
              <li>
                <Link
                  href="instagram.com/HobbyHorseTours"
                  rel="noreferrer"
                  target="_blank"
                  className="text-gray-700 transition hover:opacity-75"
                >
              ...
              <li>
                <Link
                  href="twitter.com/HobbyHorseTours"
                  rel="noreferrer"
                  target="_blank"
                  className="text-gray-700 transition hover:opacity-75"
                >
        ...
        <p className="text-xs text-gray-500">
          &copy; 2022. HobbyHorseTours. All rights reserved.
        </p>
      </div>
    </footer>
  );
