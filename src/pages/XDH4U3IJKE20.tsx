        ...
        <div className="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
          ...
          <div className="mt-4 grid grid-cols-12 gap-4 md:mt-6 md:gap-6 2xl:mt-7.5 2xl:gap-7.5">
            ...
            <div
              ...
              <div>
                <Link href="messages.html" className="flex items-center gap-5 py-3 px-7.5 hover:bg-gray-3 dark:hover:bg-meta-4">
                  ...
                  <div className="flex flex-1 items-center justify-between">
                    <div>
                      ...
                      <p>
                        <span className="text-sm font-medium text-black dark:text-white">Hello, how are you?</span>
                ...
                <Link href="messages.html" className="flex items-center gap-5 py-3 px-7.5 hover:bg-gray-3 dark:hover:bg-meta-4">
                  ...
                  <div className="flex flex-1 items-center justify-between">
                    <div>
                      ...
                      <p>
                        <span className="text-sm font-medium text-black dark:text-white">Thank you so much!</span>
