          ...
          <div className="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
            <div className="mx-auto sm:flex sm:items-center sm:justify-between">
              <div>
                  <div className="mx-auto flex items-center gap-x-3">
                      <h2 className="text-lg font-medium text-gray-800 text-black">Cities</h2>
            ...
            <div className="overflow-x-auto">
                <table className="min-w-full divide-y-2 divide-gray-200 bg-white text-sm">
                  ...
                  {props.citiesData.results.map((city) => (
                    <tr>
                      ...
                      <Link href={`/addcity/${city.id}`} className="inline-block rounded bg-indigo-600 px-4 py-2 text-xs font-medium text-white hover:bg-indigo-700"
                        >
                          View
                        </Link>
                      </td>
