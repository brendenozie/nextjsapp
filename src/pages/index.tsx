            ...
            <div className="flex flex-wrap">
              <div className="w-full md:w-1/2 p-8">
                <div className=" md:max-w-full">
                  ...
                  <h3 className="mb-6 text-xl md:text-2xl font-semibold" style={{ letterSpacing: "-0.5px" }}>&ldquo;At The Umbrella Expeditions we'll help you plan your trip effectively&amp; productively. Ensuring that you have a seamless holiday even as you travel with us touring all the places of interest !&rdquo;</h3>
