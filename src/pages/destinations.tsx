...
type Props = {
  destinationsData:{results:IDestination[]};
};
                ...
                <table className="min-w-full divide-y-2 divide-gray-200 bg-white text-sm">
                  ...
                  {props.destinationsData.results.map((destination) => (
                    <tr>
                      ...
                      <Link href={`/adddestination/${destination.id}`} className="inline-block rounded bg-indigo-600 px-4 py-2 text-xs font-medium text-white hover:bg-indigo-700"
                        >
                          View
                        </Link>
                      </td>
